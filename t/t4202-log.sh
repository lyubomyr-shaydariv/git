...
test_expect_success 'simple log -c log.showRootMark --graph' '
...
test_expect_success 'simple log -c log.showRootMark --graph --left-right' '
	test_config log.showRootMark true &&
	git log --graph --left-right --pretty=tformat:%s >actual &&
	test_cmp expect actual
'
